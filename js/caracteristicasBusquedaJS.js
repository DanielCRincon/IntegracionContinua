...
$(document).ready(function(){     
    ...
    var index;
    console.log(localStorage.getItem("caracteristicasBusqueda"));
    for(index in todos){
        var local =  parseInt(localStorage.getItem("caracteristicasBusqueda"));
        var platforms = todos[index].consola;
        var languages = todos[index].idioma;
        ...
        if(todos[index].idAll === local){
            ...
            img.append(todos[index].url);          
            img.src = '../'+todos[index].url;
            juego.append(img);
