...
$(document).ready(function(){
    ...
    for(index in videoJuegos){
        var local = parseInt(localStorage.getItem("detalles"));
        var gen = videoJuegos[index].genero;
        var consol = videoJuegos[index].consola;
        var idiomas = videoJuegos[index].idioma;
        ...
        if(videoJuegos[index].id === local){
            ...
            titulo.innerHTML = videoJuegos[index].titulo;
            ...
            valorText.innerHTML = '$ ' + videoJuegos[index].precio;
            ...
            ofertaText.innerHTML = '$ ' +  0;
            ofertaText.type = 'text';            
            ...
            image.append(videoJuegos[index].url);
            image.src = '../'+videoJuegos[index].url;
            juego.append(image);
