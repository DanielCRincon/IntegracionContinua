...
$(document).ready(function(){
    ...
    for(index in todos){
        var local = parseInt(localStorage.getItem("detallesBusqueda"));
        var gen = todos[index].genero;
        var consol = todos[index].consola;
        var idiomas = todos[index].idioma;

        if(todos[index].idAll === local){
            ...
            titulo.innerHTML = todos[index].titulo;
            ...
            image.append(todos[index].url);
            image.src = '../'+todos[index].url;
            juego.append(image);
